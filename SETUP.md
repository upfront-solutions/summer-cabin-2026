...
What those policies allow: guests can **read** everything, **add** scores and social points, and **delete** either kind. The two delete rules power the "delete a bad run" and "undo a social point" buttons. Nothing can be **edited**, only added or removed.
