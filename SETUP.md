...
Note what those policies do: guests can **add** and **read**, but nobody can **edit or delete** anything. No one can wipe the board, accidentally or otherwise. You can still fix mistakes yourself from the Supabase **Table Editor**.

### Step 3 · Paste your two keys into the site

In Supabase go to **Project Settings → API**. You need two values:
